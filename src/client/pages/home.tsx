        ...
        <>
            ...
            <div className="row mb-4">
                ...
                <div className="col-12 col-md-6 bg-light py-3">
                    ...
                    <p className="lead">
                        Приложение написано на typescript+react со сборкой на vite, есть серверная часть.
                        Использованы популярные библиотеки: react-router, react-query, redux-toolkit
                    </p>
                </div>
            </div>
            <div className="row">
